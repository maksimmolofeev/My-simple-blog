...
export default {
    ...
    // cacheDirectory: "C:\\Users\\Maks\\AppData\\Local\\Temp\\jest",
    ...
    // The number of seconds after which a test is considered as slow and reported as such in
    // the results.
    // slowTestThreshold: 5,
    ...
    // This option sets the URL for the jsdom environment. It is reflected in properties
    // such as location.href
